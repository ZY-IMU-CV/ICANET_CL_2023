...
if __name__=='__main__': 
    ...
    config["log_path"] = "./log_file/LightSeg_test_15_camvid"
    config["save_best_path"] = './pth_file/best_LightSeg_15_camvid.pth'
    #config["train_split"]="trainval"
    #config["batch_size"] = 8
    #config["train_crop_size"] = [1024,2048]  
    config["pretrained_path"] = './pth_file/best_LightSeg_0_4.pth'
    #config["epochs"] = 500 
