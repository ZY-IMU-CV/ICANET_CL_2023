...
if __name__ =="__main__":
    ...
    config["model_name"] = "LightSegE0_LightSegD0"
    config["save_best_path"] = './pth_file/best_LightSeg_0_2.pth' 
    class_num = 19
    hist = np.zeros((class_num, class_num))
    val_data = val_data.get_cityscapes("../CLReg_prog/cityscapes_dataset/",(360,640),(360,640),0.5,'val',4)
